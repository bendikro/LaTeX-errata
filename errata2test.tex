...
%% Alternative hack to remove line numbers in margin
...
inlinemarks=true,
%styles={legacy, detailed, tablelist},
%styles={detailed},
...
\erratumAdd[margin=false, foot=true, description={First forrection}]{before chap1}
...
\erratumAdd[margin=false, foot=true, description={Second correction}]{In par1}

\erratumAdd[margin=false, foot=true, description={Added}]{In par1}
...
Therefore, the'
\erratumReplace[id={testid}, type={Correction}, description={Fix typo}, reported-by=bro]{results}{result}'
...
\erratumReplace[id={testid}, description={Fix typo}]{tulls}{tull}
...
\erratumReplace[type={grammar}, description={Fix grammar}]{in}{of}

\subsubsection{Subsubsection 1.1.1}\label{subsubsect-one}

\erratumAdd[id={testid}, description={Fix grammar}]{insubsubsect}

SUBSUBSECT1: \cref{subsubsect-one} (\getCurrentSectionNumber)

\paragraph{Paragraph 1}\label{par-one}

\erratumAdd[id={testid}, description={Fix grammar}]{inparagraph}
...
\erratumAdd[id={testid}, description={Fix grammar}]{insubsubsecttwo}
...
\erratumAdd[id={testid}, description={Fix grammar}]{insubsect2}
...
inlinemark: \erratumAdd[inlinemark=true,inlinechange=false]{inlinemark}

inlinechange: \erratumAdd[inlinemark=false,inlinechange=true]{inlinechange}
...
marginargs={colframe=blue!50!white},foot=true,description=Desc]
...
\section{List}\label{subsect-inlinelist}
...
\begin{inlinelist}
  ...
  \item{} has the \erratumAdd[type={grammar}]{test linelabel in inner mode}
...
\begin{inlinelist}
  \item{} has the \erratumDelete[type={grammar}]{the} same behavior, and
